...
export function assertDebugToken(symbol: string): asserts symbol is DebugTokens {
...
export const toDebugStrategy = (testCase: CreateStrategyTestCase): CreateStrategyInput => {
