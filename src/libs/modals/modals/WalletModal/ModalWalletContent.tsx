        ...
        <div className="space-y-10">
            <div className="text-14 mb-20 space-y-10 text-white/80">
                <p>
                    ...
                    <Link to="/terms" target="_blank" className="font-weight-500 text-white">
                        terms & conditions
                    </Link>{' '}
                    and{' '}
                    <Link target="_blank" to="/privacy" className="font-weight-500 text-white">
                ...
                <div className="flex items-center space-x-10">
                    ...
                    <button onClick={() => setChecked((prev) => !prev)}>I read and accept</button>
                </div>
            </div>
            ...
            {connectors.map((c) => {
                return (
                    <button
                        ...
                        disabled={isDisabled}
                    >
                        <WalletIcon selectedWallet={c.name} className="w-24" icon={c.icon} />
