...
export const getLastVisitedPair = () => {
    const [base, quote] = lsService.getItem('tradePair') || config.defaultTokenPair;
...
export const validBoolean = v.boolean([v.custom((value) => value === true || value === false)]);
...
export const validateSearchParams = <T>(validator: SearchParamsValidator<T>) => {
