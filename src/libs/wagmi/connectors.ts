...
export const isPlaceHolderConnector = (c: Connector) => c.type.endsWith(PLACEHOLDER_TAG);
...
export const providerRdnsToName = (connectionName: string): string | undefined =>
    providerMapRdnsToName[connectionName];
