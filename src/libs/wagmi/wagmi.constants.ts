...
const CHAIN_RPC_URL = tenderlyRpc || import.meta.env.VITE_CHAIN_RPC_URL || config.network.rpc.url;
const CHAIN_RPC_HEADERS = tenderlyRpc || IS_ENV_RPC ? {} : config.network.rpc?.headers || {};
...
export const selectedConnectors: SelectableConnectionName[] = config.selectedConnectors;
