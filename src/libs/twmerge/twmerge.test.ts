...
describe('Custom Tailwind Merge', () => {
    describe('font size and color', () => {
        ...
        it('should merge different colors', () => {
            expect(customTwMerge('text-white text-primary')).toEqual(customTwMerge('text-primary'));
        });
        it('should merge different sizes', () => {
            expect(customTwMerge('text-14 text-16')).toEqual(customTwMerge('text-16'));
        });
    });
    describe('borderRadius', () => {
        it('should merge different sizes', () => {
            expect(customTwMerge('rounded-14 rounded-16')).toEqual(customTwMerge('rounded-16'));
        });
        it('should merge sizes with numbers and names', () => {
            expect(customTwMerge('rounded-14 rounded-full')).toEqual(customTwMerge('rounded-full'));
        });
    });
    describe('border', () => {
        it('should merge different colors', () => {
        ...
        it('should merge different colors', () => {
            expect(customTwMerge('border border-primary/60 border-background-800')).toEqual(
                customTwMerge('border border-background-800')
            );
        });
    ...
    describe('opacity', () => {
        it('should merge different sizes', () => {
            expect(customTwMerge('opacity-5 opacity-10')).toEqual(customTwMerge('opacity-10'));
        });
    });
    describe('spacing', () => {
        describe('space', () => {
            it('should merge different sizes in space x', () => {
                expect(customTwMerge('space-x-14 space-x-16')).toEqual(customTwMerge('space-x-16'));
            });
            it('should merge different sizes in space y', () => {
                expect(customTwMerge('space-y-14 space-y-16')).toEqual(customTwMerge('space-y-16'));
            });
        ...
        describe('margin', () => {
            ...
            it('should merge different sizes with mx before mr', () => {
                expect(customTwMerge('mx-5 mr-10')).toEqual(customTwMerge('mx-5 mr-10'));
            });
            ...
            it('should merge different sizes with my before mt', () => {
                expect(customTwMerge('my-5 mt-10')).toEqual(customTwMerge('my-5 mt-10'));
            });
            ...
            it('should merge different margin-auto', () => {
                expect(customTwMerge('m-auto my-5')).toEqual(customTwMerge('m-auto my-5'));
            });
        });
        describe('padding', () => {
            ...
            it('should merge different sizes with px before pr', () => {
                expect(customTwMerge('px-5 pr-10')).toEqual(customTwMerge('px-5 pr-10'));
            });
            ...
            it('should merge different sizes with py before pt', () => {
                expect(customTwMerge('py-5 pt-10')).toEqual(customTwMerge('py-5 pt-10'));
            });
            it('should merge different sizes with pt before py', () => {
                expect(customTwMerge('pt-10 py-5')).toEqual(customTwMerge('py-5'));
            });
    ...
    describe('font weight', () => {
        ...
        it('should not merge size with family', () => {
            expect(customTwMerge('font-weight-300 font-weight-500 font-mono')).toEqual(
                customTwMerge('font-weight-500 font-mono')
            );
        });
    });
    describe('size and height/width', () => {
        ...
        it('should merge different sizes with size before h', () => {
            expect(customTwMerge('size-5 h-10')).toEqual(customTwMerge('size-5 h-10'));
        });
        ...
        it('should merge different sizes with size before w', () => {
            expect(customTwMerge('size-5 w-10')).toEqual(customTwMerge('size-5 w-10'));
        });
    ...
    describe('max width', () => {
        it('should merge different sizes', () => {
            expect(customTwMerge('max-w-0 max-w-xl')).toEqual(customTwMerge('max-w-xl'));
        });
        it('should merge different sizes', () => {
            expect(customTwMerge('max-w-xl max-w-full')).toEqual(customTwMerge('max-w-full'));
        });
    });
});
