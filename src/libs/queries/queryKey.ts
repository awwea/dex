...
export namespace QueryKey {
    ...
    export const activities = (params: QueryActivityParams) => [...extAPI, 'activity', params];
    ...
    export const simulator = (params: SimulatorResultSearch) => [...extAPI, 'simulator', params];

    export const tokens = () => [...extAPI, 'tokens'];
    export const tokenPrice = (address: string) => [...extAPI, 'token-price', address];
    ...
    export const strategies = (user?: string) => [...sdk, 'strategies', 'user', user];
    ...
    export const ensFromAddress = (address: string) => [...chain, 'ens', 'address', address];

    export const balance = (user: string, token: string) => [...chain, 'balance', user, token];
    ...
    export const tradeData = (pair: TokenPair, isTradeBySource: boolean, amount: string) => [
        ...sdk,
    ...
    ) => [...sdk, buildTokenPairKey(pair), 'trade-actions', isTradeBySource, actions];
