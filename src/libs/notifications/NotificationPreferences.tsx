...
export const NotificationPreferences = () => {
    const [preferences, setPreferences] = useState(lsService.getItem('notificationPreferences'));
    ...
    return (
        <form onChange={onChange} className="mt-24">
            <div className="rounded-6 flex border-2 border-white/10 px-16 py-8">
                <h3 id="global-notif-label" className="text-16 flex flex-1 items-center gap-8">
