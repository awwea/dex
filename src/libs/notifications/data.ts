...
export const NOTIFICATIONS_MAP: NotificationsMap = {
    ...
    reject: () => ({
        ...
        description: 'You rejected the transaction. If this was by mistake, please try again.',
        showAlert: true,
        nonPersistent: true,
        testid: 'reject',
    }),
    approve: ({ symbol, limited, txHash }) => ({
        ...
        failedDesc: `Failed ${symbol} approval for ${limited ? 'limited' : 'unlimited'}`,
        showAlert: true,
        testid: 'approve',
    }),
    revoke: ({ txHash }) => ({
    ...
    renewStrategy: (data) => ({
        ...
        successTitle: 'Success',
        successDesc: 'Your request to renew the strategy was successfully completed.',
        failedTitle: 'Transaction Failed',
