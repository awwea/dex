import { InternalStrategyInput, useStrategyInput } from 'hooks/useStrategyInput';
...
export type SimulatorInputDispatch = <T extends InternalStrategyInput, K extends keyof T>(
    key: K,
    value: T[K],
    setBounds?: boolean
) => void;
