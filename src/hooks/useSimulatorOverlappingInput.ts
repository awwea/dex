...
export interface InternalSimulatorOverlappingInput extends SimulatorInputOverlappingSearch {
    buyMax?: string;
    sellMin?: string;
    buyBudget?: string;
    sellBudget?: string;
...
export const useSimulatorOverlappingInput = ({ searchState }: Props) => {
    ...
    const [_state, setState] = useState<InternalSimulatorOverlappingInput>(searchState);
