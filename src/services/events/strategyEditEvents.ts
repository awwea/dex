...
import { CarbonEvents, EventCategory, StrategyEditGTMEventType } from './googleTagManager/types';
    ...
    strategyDeposit: (strategy) => {
        ...
        gtmData &&
            sendGTMEvent('strategyEdit', 'strategyDeposit', {
                ...
                strategy_sell_high_deposit_budget_usd: strategy.sellHighDepositBudgetUsd,
            });
    },
    strategyWithdraw: (strategy) => {
        ...
        gtmData &&
            sendGTMEvent('strategyEdit', 'strategyWithdraw', {
                ...
                strategy_buy_low_withdrawal_budget_usd: strategy.buyLowWithdrawalBudgetUsd,
                strategy_sell_high_withdrawal_budget: strategy.sellHighWithdrawalBudget,
                strategy_sell_high_withdrawal_budget_usd: strategy.sellHighWithdrawalBudgetUsd,
            });
    },
