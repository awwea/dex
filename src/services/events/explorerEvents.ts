import { StrategyFilter, StrategySort } from 'components/strategies/overview/StrategyFilterSort';
...
function toGmtExplorerSearch(input: ExplorerSearchInput) {
    ...
    return {
        ...
        explore_search_token_pair: type === 'token-pair' && slug ? slug.replace('_', '/') : null,
        explore_search_base_token: type === 'token-pair' && slug ? slug.split('_').shift()! : null,
        explore_search_quote_token: type === 'token-pair' && slug ? slug.split('_').pop()! : null,
