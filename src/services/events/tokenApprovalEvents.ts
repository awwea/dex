...
export const tokenApprovalEvents: CarbonEvents['tokenApproval'] = {
    tokenConfirmationViewStrategyCreate: (data) => {
        const tokenApprovalData = prepareTokenApprovalStrategyGTMData(data, 'strategy_create');
        sendGTMEvent(
            'tokenApproval',
    ...
    tokenConfirmationViewDepositStrategyFunds: (data) => {
        const tokenApprovalData = prepareTokenApprovalStrategyGTMData(data, 'strategy_deposit');
        sendGTMEvent(
            'tokenApproval',
