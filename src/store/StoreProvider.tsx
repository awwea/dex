...
import { defaultModalStore, ModalStore, useModalStore } from 'store/useModalStore';
import { defaultTokensStore, TokensStore, useTokensStore } from 'store/useTokensStore';
...
import { defaultToastStore, ToastStore, useToastStore } from 'store/useToasterStore';
...
export const StoreProvider: FC<{ children: ReactNode }> = ({ children }) => {
    ...
    const [simDisclaimerLastSeen, _setSimDisclaimerLastSeen] = useState<number | undefined>(
