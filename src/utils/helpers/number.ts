 ...
 */
const highPrecision = (num: SafeDecimal, formatter: Intl.NumberFormat, maxDecimals: number = 6) => {
...
export function prettifyNumber(value: NumberLike, options: PrettifyNumberOptions = {}): string {
