...
describe('Test helpers', () => {
    ...
    describe('prettifyNumber', () => {
        ...
        describe('Currency', () => {
            ...
            test('should return ¥0.00 for input lower then 0 and currentCurrency is JPY', () => {
                expect(prettifyNumber(-10, { currentCurrency: 'JPY' })).toEqual('¥0.00');
            });
            ...
            test('should return "$0.001" for input 0.001 and currentCurrency is USD', () => {
                expect(prettifyNumber(0.001, { currentCurrency: 'USD' })).toEqual('$0.001');
            });

            test('should return "€0.001" for input 0.001 and currentCurrency is EUR', () => {
                expect(prettifyNumber(0.001, { currentCurrency: 'EUR' })).toEqual('€0.001');
            });

            test('should return "0.001 ETH" for input 0.001 and currentCurrency is ETH', () => {
                expect(prettifyNumber(0.001, { currentCurrency: 'ETH' })).toEqual('0.001 ETH');
            });

            test('should return "0.0₃1 ETH" for input 0.0001 and currentCurrency is ETH', () => {
                expect(prettifyNumber(0.0001, { currentCurrency: 'ETH' })).toEqual('0.0₃1 ETH');
            });

            test('should return "0.0₄1 ETH" for input 0.00001 and currentCurrency is ETH', () => {
                expect(prettifyNumber(0.00001, { currentCurrency: 'ETH' })).toEqual('0.0₄1 ETH');
            });

            test('should return "¥0.001" for input 0.001 and currentCurrency is JPY', () => {
                expect(prettifyNumber(0.001, { currentCurrency: 'JPY' })).toEqual('¥0.001');
            });
            ...
            test('should return "1.23 ETH" for input 1.2345 and currentCurrency is ETH', () => {
                expect(prettifyNumber(1.2345, { currentCurrency: 'ETH' })).toEqual('1.23 ETH');
            });

            test('should return "¥1.23" for input 1.2345 and currentCurrency is JPY', () => {
                expect(prettifyNumber(1.2345, { currentCurrency: 'JPY' })).toEqual('¥1.23');
            });
            ...
            test('should display 5 significant numbers when there is at least 6 zeros in a row', () => {
                const option = { highPrecision: true, currentCurrency: 'JPY' } as const;
                expect(prettifyNumber(0.000000123456789, option)).toEqual('¥0.00000012345');
            });
        });
        ...
        describe('Numbers', () => {
            ...
            test('Abbreviate should not display K for thousands', () => {
                expect(prettifyNumber(123456, { abbreviate: true })).toEqual('123,456.00');
            });
            ...
            test('Abbreviate should display B for billions', () => {
                expect(prettifyNumber(1234567890, { abbreviate: true })).toEqual('1.23B');
            });
            test('Abbreviate should display T for trillions', () => {
                expect(prettifyNumber(1234567890000, { abbreviate: true })).toEqual('1.23T');
            });
            ...
            test('High precision should has 5 significant digits if there is 6 zeros', () => {
                const option = { highPrecision: true };
                expect(prettifyNumber(0.0000001234567, option)).toEqual('0.00000012345');
                expect(prettifyNumber(0.000000000001234567, option)).toEqual('0.0000000000012345');
            });
    ...
    describe('formatNumberWithApproximation', () => {
        const testCases: [
            ...
            [new SafeDecimal(0), { isPercentage: true }, { value: '0.00%', negative: false }],
            [
                new SafeDecimal(0.005),
                { approximateBelow: 0.2, isPercentage: true },
                { value: '< 0.2%', negative: false },
            ],
            [new SafeDecimal(0.01), { approximateBelow: 0.01 }, { value: '0.01', negative: false }],
            [
    ...
    describe('roundSearchParam', () => {
        ...
        test('If inputValue >= 1, apply 6 decimal accuracy', () => {
            expect(roundSearchParam('12345.12345678901234567890')).toBe('12345.123456');
