...
export const DebugCreateStrategy = () => {
    ...
    const balancesMap = useMemo(() => {
        return new Map(balanceQueries.map((t, i) => [selectedTokens[i].address, t.data]));
    ...
    const create = async () => {
        ...
        for (let i = 0; i <= rounds - 1; i++) {
            ...
            try {
                ...
                console.log('created strategy', strategy.base.address, strategy.quote.address);
            } catch (e) {
                console.error(
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-8">
                ...
                ></textarea>
                <p id="strategy-json-shortcut-description" className="text-12 text-white/60">
            ...
            <fieldset className="flex flex-col gap-8 rounded border border-white/60 p-16">
                ...
                <p id="strategy-spread-description" className="text-12 text-white/60">
                    Spread will create a concentrated liquidity. You still need to set the correct
                    budget.
                </p>
            </fieldset>
