import { StrategyInputDispatch, StrategyInputOrder } from 'hooks/useStrategyInput';
...
export const LimitRangeSection: FC<Props> = ({
    ...
    const overlappingOrdersPricesMessage = 'Notice: your Buy and Sell orders overlap';
    ...
    const getWarnings = () => {
        let warnings = [];
        if (isOrdersOverlap && !isOrdersReversed) warnings.push(overlappingOrdersPricesMessage);
