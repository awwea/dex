...
import { getSelector, useSelectable } from 'components/simulator/input/d3Chart/utils';
...
export const D3ChartHandle = ({ onDragStart, onDrag, onDragEnd, isLimit, ...props }: Props) => {
    ...
    const handleDrag = drag()
        ...
        .on('end', ({ y }) => {
            ...
            const oppositeY = Number(getSelector(props.selectorOpposite).select('line').attr('y1'));
