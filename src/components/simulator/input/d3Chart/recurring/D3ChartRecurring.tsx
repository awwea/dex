...
export const D3ChartRecurring = ({
    ...
    const onMinMaxChange = useCallback(
        ...
        [onPriceUpdates, prices.buy.max, prices.buy.min, prices.sell.max, prices.sell.min, yScale]
    );
    ...
    const onMinMaxChangeEnd = useCallback(
        ...
        [onDragEnd, prices.buy.max, prices.buy.min, prices.sell.max, prices.sell.min, yScale]
    );
