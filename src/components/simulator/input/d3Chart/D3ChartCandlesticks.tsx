...
import { D3YAxisRight, useLinearScale, CandlestickData, scaleBand, D3ChartSettings } from 'libs/d3';
...
export const D3ChartCandlesticks = (props: D3ChartCandlesticksProps) => {
    ...
    return (
        <>
            ...
            <D3YAxisRight ticks={y.ticks} dms={dms} formatter={(value) => prettifyNumber(value)} />
