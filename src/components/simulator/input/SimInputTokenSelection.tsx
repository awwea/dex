...
export const SimInputTokenSelection: FC<Props> = ({ baseToken, quoteToken, noPriceHistory }) => {
        ...
        >
            ...
            <article className="font-weight-500 flex flex-row items-center -space-x-10">
                <SelectTokenButton
                    ...
                    description={
                        <span
                            className={`${base ? 'text-white/60' : 'text-black'} font-weight-500`}
                        >
                            Buy or Sell
                        </span>
                    }
                ...
                <SelectTokenButton
                    ...
                    description={
                        <span
                            className={`${quote ? 'text-white/60' : 'text-black'} font-weight-500`}
                        >
                            With
                        </span>
                    }
