...
import { checkIfOrdersOverlap, checkIfOrdersReversed } from 'components/strategies/utils';
import { StrategyInputValues, StrategyInputDispatch } from 'hooks/useStrategyInput';
...
export const SimInputRecurring = ({ state, dispatch, firstHistoricPricePoint }: Props) => {
