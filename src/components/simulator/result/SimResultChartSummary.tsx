...
export const SimResultChartSummary = ({ data, bounds, baseToken, quoteToken }: Props) => {
    return (
        <div className="border-background-800 flex w-full border-t" data-testid="chart-summary">
            <p
            ...
            <D3ChartWrapper className="min-h-[600px] flex-1" settings={chartSettingsSummary}>
                {(dms) => <D3ChartSimulatorSummary data={data} bounds={bounds} dms={dms} />}
            </D3ChartWrapper>
            <p
