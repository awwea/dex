...
export const SimResultSummaryGains: FC<Props> = ({ portfolioGains, quoteToken }) => {
...
const TooltipContent: FC<{}> = () => (
    <>
        <p className="align-middle">
            Estimated gains your trading strategy might have generated over the specified period.
            Amounts are denominated in the quote token.
        </p>
    </>
);
