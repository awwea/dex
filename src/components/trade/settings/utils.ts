type TradeSettingsDataId = 'slippageTolerance' | 'transactionExpiration' | 'maxOrders';
...
export const warningMessageIfOutOfRange = (id: TradeSettingsDataId, value: string): string => {
...
export const isValidValue = (id: TradeSettingsDataId, value: string): boolean => {
    const numberedValue = +value;
    switch (id) {
        case 'slippageTolerance':
