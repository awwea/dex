...
export const ActivityNotification: FC<Props> = ({ notification, close, onClick }) => {
    const titleId = useId();
    ...
    return (
        <article aria-labelledby={titleId} className="flex gap-16">
            ...
            <div className="flex flex-col items-end justify-between">
                <button onClick={close} data-testid="notif-close" aria-label="Remove notification">
...
export const AnimatedActionIcon = (props: { action: ActivityAction }) => {
    ...
    return (
        <div
            className={cn('size-38 relative grid place-items-center rounded-full', style.icon, {
