...
export const toActivities = (data: ServerActivity[], tokensMap: Map<string, Token>): Activity[] => {
...
const toMetaActivities = (meta: ServerActivityMeta, tokenMap: Map<string, Token>) => {
