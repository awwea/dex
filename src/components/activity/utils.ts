...
import { prettifyNumber, shortenString, tokenAmount, tokenRange } from 'utils/helpers';
...
export const activityActions = Object.keys(activityActionName) as ActivityAction[];

export const validateActivityParams = validateSearchParams<ActivitySearchParams>({
