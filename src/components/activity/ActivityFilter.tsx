...
import { DateRangePicker, datePickerPresets } from 'components/common/datePicker/DateRangePicker';
        ...
        >
            {filters.includes('ids') && (
                <Combobox
                    ...
                    label={ids?.length ? `${ids.length} Strategies Selected` : 'Filter Strategies'}
            ...
            {filters.includes('pairs') && (
                <Combobox
                    ...
                    label={pairs?.length ? `${pairs.length} Pairs Selected` : 'Filter Pairs'}
            ...
            <Combobox
                ...
                value={actions ?? []}
                icon={<IconSearch className="text-primary w-14" />}
                label={actions?.length ? `${actions.length} Actions Selected` : 'Filter Actions'}
