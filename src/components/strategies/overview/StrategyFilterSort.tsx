...
const isEnumSort = (sort: StrategySort | EnumStrategySort): sort is EnumStrategySort =>
    sort in strategySortMapping;
...
const isEnumFilter = (filter: StrategyFilter | EnumStrategyFilter): filter is EnumStrategyFilter =>
    filter in strategyFilterMapping;
