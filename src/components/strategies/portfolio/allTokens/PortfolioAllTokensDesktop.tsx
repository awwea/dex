...
import { buildAmountString, buildPercentageString } from 'components/strategies/portfolio/utils';
...
export const PortfolioAllTokensDesktop: FC<Props> = ({ data, isPending, onRowClick }) => {
    const {
    ...
    const tableColumns = useMemo(
        () => [
            ...
            columnHelper.accessor('amount', {
                header: 'Amount',
                cell: (info) => buildAmountString(info.getValue(), info.row.original.token),
            }),
            columnHelper.accessor('value', {
                header: 'Value',
                cell: (info) => getFiatDisplayValue(info.getValue(), selectedFiatCurrency),
            }),
        ],
