...
export type StrategyOption = 'buy-limit' | 'range-order' | 'two-ranges' | 'overlapping';
...
export const strategyOptionItems = (base: string, quote: string): StrategyOptionItem[] => [
    {
        label: 'Limit Order',
        description: 'A single disposable buy or sell order at a specific price',
        benefits: [
            {
                summary: '100% Adjustable',
                details:
            ...
            },
            {
                ...
                details:
                    'Makers pay no gas when a trade is executed, and there are currently no maker fees on DFI.',
            },
        ],
    ...
    {
        label: 'Range Order',
        description: 'A single disposable buy or sell order within a custom price range',
        benefits: [
            {
