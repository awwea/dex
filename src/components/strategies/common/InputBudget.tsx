import { ChangeEvent, FC, FocusEvent, MouseEvent, useEffect, useId, useRef, useState } from 'react';
import { Token } from 'libs/tokens';
import { formatNumber, prettifyNumber, roundSearchParam, sanitizeNumber } from 'utils/helpers';
...
export const InputBudget: FC<Props> = (props) => {
    ...
    const { getFiatValue, selectedFiatCurrency: currentCurrency } = useFiatCurrency(token);
