...
import { subDays, isSameDay, subMonths, startOfDay, endOfDay, format } from 'date-fns';
...
export const DateRangePicker = memo(function DateRangePicker(props: Omit<Props, 'setIsOpen'>) {
    ...
    const Trigger = (attr: MenuButtonProps) => (
        ...
        >
            ...
            <span className="justify-self-end text-white/60" data-testid="simulation-dates">
...
const getDefaultDateRange = (start?: Date, end?: Date): DateRange | undefined => {
