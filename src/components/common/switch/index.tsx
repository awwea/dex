...
type SwitchHTMLProps = DetailedHTMLProps<BaseHTMLAttributes<HTMLDivElement>, HTMLDivElement>;
...
export const Switch: FC<SwitchProps> = ({
    ...
    return (
        <>
            <div
                className={cn('relative', switchStyles({ variant, size, isOn, class: className }))}
                {...props}
            >
                <input
