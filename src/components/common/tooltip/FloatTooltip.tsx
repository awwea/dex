...
export const FloatTooltip: FC<FloatTooltipProps> = ({ children, ...options }) => {
    const FloatTooltip = useFloatTooltip(options);
    return (
        <FloatTooltipContext.Provider value={FloatTooltip}>{children}</FloatTooltipContext.Provider>
    );
};

export const FloatTooltipTrigger = forwardRef<HTMLElement, HTMLProps<HTMLElement>>(
...
export const FloatTooltipContent = forwardRef<HTMLDivElement, HTMLProps<HTMLDivElement>>(
