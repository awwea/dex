...
export const useImager = (src: string = genericToken, fallbackSrc: string = genericToken) => {
...
type ImgAttributes = DetailedHTMLProps<ImgHTMLAttributes<HTMLImageElement>, HTMLImageElement>;
...
export const Imager = ({ src, alt, lazy = true, fallbackSrc, ...props }: ImageProps) => {
