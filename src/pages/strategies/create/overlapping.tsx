...
import { CreateForm, CreateFormHeader } from 'components/strategies/create/CreateForm';
...
const getOrders = (search: Search, base?: Token, quote?: Token, marketPrice?: string) => {
