...
import { useCompareTokenPrice, useGetTokenPriceHistory } from 'libs/queries/extApi/tokenPrice';
...
export const SimulatorInputRecurringPage = () => {
    ...
    const noBudgetText = !isError && noBudget && 'Please add Sell and/or Buy budgets';
